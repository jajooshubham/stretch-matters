import type { Route } from "./+types/stretch-network";
import { getStretchNetworkContent, type PageContent } from "~/services/pageContent";
...
export function loader() {
  return getStretchNetworkContent();
}

export default function StretchNetwork({ loaderData: data }: Route.ComponentProps) {
  if (!data) return null;
  const content = data as PageContent;
