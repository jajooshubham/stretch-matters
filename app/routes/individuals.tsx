import type { Route } from "./+types/individuals";
import { getIndividualsContent, type PageContent } from "~/services/pageContent";
...
export function loader() {
  return getIndividualsContent();
}

export default function Individuals({ loaderData: data }: Route.ComponentProps) {
  if (!data) return null;
  const content = data as PageContent;
